...
if __name__ == "__main__":
    ...
    df_x, df_y = get_exp_based_df(experiment9)
    ...
    model, experiment_name = get_model(input_shape, rnn_layer='lstm',
                                       name=';stm', is_bidirectional=False)
    ...
    if IS_TRAINING:
        ...
        model.save(data_path + '../../output/results/trained_model/%s' %
                   experiment_name,save_format="tf")
